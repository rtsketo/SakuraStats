...
public class MagicTextView extends AppCompatTextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_foregroundy)){
				Drawable foreground = a.getDrawable(R.styleable.MagicTextView_foregroundy);
				if(foreground != null){
					this.setForegroundDrawable(foreground);
				}else{
					this.setTextColor(a.getColor(R.styleable.MagicTextView_foregroundy, 0xff000000));
				}
			}
		
			if(a.hasValue(R.styleable.MagicTextView_backgroundy)){
				Drawable background = a.getDrawable(R.styleable.MagicTextView_backgroundy);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_backgroundy, 0xff000000));
				}
			}
